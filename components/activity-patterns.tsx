...
export function ActivityPatterns() {
  ...
  const getActivityIntensityClass = (intensity: number) => {
    return safeCn(
      conditionalCn({
        ...
        false: conditionalCn({
          ...
          true: "bg-green-200 dark:bg-green-900",
          false: conditionalCn({
            condition: intensity === 2,
            true: "bg-green-500 dark:bg-green-700",
            false: "bg-green-700 dark:bg-green-500",
          }),
        }),
      }),
    )
                      ...
                      <div
                        ...
                        className={safeCn(
                          ...
                          conditionalCn({
                            ...
                            false: "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300",
                          }),
                        )}
              ...
              {heatmapData.map((day, i) => {
                ...
                return (
                  <div key={i} className="space-y-1 text-center" role="cell">
                    ...
                    <div
                      id={dayId}
                      className={safeCn("h-8 rounded-sm", getActivityIntensityClass(day.value))}
