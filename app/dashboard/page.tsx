...
export default function DashboardPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="mb-6 text-2xl font-bold">Wellness Dashboard</h1>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Welcome back, {user.user_metadata?.full_name || user.email}! Here's an overview of your wellness
                journey.
              </p>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {entries.length > 0
                    ? `Last entry: ${new Date(entries[0].date).toLocaleDateString()}`
                    : "No entries yet"}
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  Tracking across {enabledCategories.length} wellness areas
                </p>
              </CardContent>
            </Card>
            <Card>
                    ...
                    <Card key={entry.id}>
                      ...
                      <CardContent className="py-2">
                        <div className="flex flex-wrap gap-2">
                          ...
                          {entry.metrics.length > 5 && (
                            <Badge variant="outline">+{entry.metrics.length - 5} more</Badge>
                          )}
                        </div>
                      </CardContent>
                    </Card>
